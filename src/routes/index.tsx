...
import { Copy, Check, Search, Github, Globe, Linkedin, Mail, Code2, Sparkles, Twitter, Layers, Pencil, RotateCcw, ExternalLink, History, Trash2, Clock, X } from "lucide-react";
              ...
              <ConnectChip
                ...
                icon={
                  <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
                    ...
                    <path
                      fill="white"
                      d="M7.1 9.5h2.6v8.2H7.1V9.5zm1.3-4.1a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zM11.4 9.5H13.9v1.12h.04c.35-.63 1.2-1.3 2.47-1.3 2.64 0 3.13 1.6 3.13 3.68v4.7h-2.6v-4.17c0-1 -.02-2.28-1.4-2.28-1.4 0-1.62 1.08-1.62 2.2v4.25h-2.6V9.5z"
                    />
                  </svg>
                }
                label="LinkedIn"
              ...
              <ConnectChip
                ...
                icon={
                  <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
                    ...
                    <path transform="translate(3 3) scale(0.75)" fill="white" d="M12 .5C5.73.5.75 5.48.75 11.75c0 4.94 3.2 9.13 7.64 10.61.56.1.77-.24.77-.54 0-.27-.01-1-.02-1.96-3.11.67-3.77-1.5-3.77-1.5-.51-1.29-1.25-1.63-1.25-1.63-1.02-.7.08-.68.08-.68 1.13.08 1.72 1.16 1.72 1.16 1 1.72 2.63 1.22 3.27.93.1-.73.39-1.22.71-1.5-2.48-.28-5.09-1.24-5.09-5.52 0-1.22.44-2.22 1.16-3-.12-.28-.5-1.42.11-2.96 0 0 .94-.3 3.09 1.15.9-.25 1.86-.38 2.82-.38.96 0 1.92.13 2.82.38 2.15-1.45 3.09-1.15 3.09-1.15.61 1.54.23 2.68.11 2.96.72.78 1.16 1.78 1.16 3 0 4.29-2.62 5.24-5.11 5.51.4.35.76 1.03.76 2.08 0 1.5-.01 2.71-.01 3.08 0 .3.2.65.78.54 4.43-1.48 7.63-5.67 7.63-10.61C23.25 5.48 18.27.5 12 .5z" />
                  </svg>
                }
                label="GitHub"
              />
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-sm">
                ...
                <li>
                  <a className="inline-flex items-center gap-2 text-muted-foreground transition hover:text-foreground" href="https://medium.com/@surajdsharma" target="_blank" rel="noreferrer">
                    <Globe className="h-4 w-4" /> medium.com/@surajdsharma
                  </a>
                </li>
